...
public class DeleteWeapon extends DeclarativeWebScript {
	
	private static Log LOG = LogFactory.getLog(DeleteWeapon.class);
	...
	protected Map<String, Object> executeImpl(WebScriptRequest req, Status status) {
		LOG.debug("Inside the DeleteWeapon Webscript");

...
public class DeleteOperator extends DeclarativeWebScript {
	
	private static Log LOG = LogFactory.getLog(DeleteOperator.class);
	...
	protected Map<String, Object> executeImpl(WebScriptRequest req, Status status) {
		LOG.debug("Inside the DeleteOperator Webscript");
